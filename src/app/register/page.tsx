...
import { User, Mail, Lock, Eye, EyeOff, Shield, ArrowLeft, CheckCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#06030c] text-white flex items-center justify-center relative overflow-hidden font-sans py-12">
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-[rgba(17,8,32,0.9)] border border-[rgba(191,95,255,0.2)] backdrop-blur-xl rounded-2xl" style={{ boxShadow: '0 0 60px rgba(191,95,255,0.1)' }}>
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Join HpLabs</h1>
          <p className="text-gray-400 text-sm">Start your hacking journey</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-400">
            Already have access?{' '}
            <button onClick={() => router.push('/login')} className="font-medium text-[#bf5fff] hover:text-[#d89eff] hover:underline transition-colors">
              Initialize session
            </button>
          </p>
        </div>
