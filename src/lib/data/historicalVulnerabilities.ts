...
export const HISTORICAL_VULNERABILITY_CATALOG: DetailedHistoricalLab[] = [
  ...
  },
  {
    ...
    severity: "critical",
    domain: "web",
    name: "Real-Time Critical Zero-Day Vulnerability Disclosure (2026)",
    shortName: "Real-Time Zero-Day Ingestion (2026)",
    description: "Live zero-day vulnerability disclosure ingested into HpLabs research pipeline in 2026. Fully classified and integrated with automated server-side flag validation.",
    history: "Synchronized automatically via HpLabs dynamic background ingestion pipeline in 2026.",
    firstDiscoveredYear: 2026,
    cvssScore: 9.6,
    cwe: ["CWE-200", "CWE-287"],
    cve: ["CVE-2026-5912"],
