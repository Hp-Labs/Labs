...
for line in lines:
    ...
    if in_table and line.startswith("|"):
        ...
        if "ad-" in l or "active directory" in v or "kerberos" in v or "bloodhound" in v:
            ...
            target_type = "NEEDS SPECIALIZED ENVIRONMENT"
        elif "api-" in l or "graphql" in v or "jwt" in v or "rest" in v or "oauth" in v:
            if "graphql" in v:
                family = "GraphQL"
                app = "GraphQL API"
            ...
            target_type = "NEEDS SPECIALIZED ENVIRONMENT"
        elif "sys-" in l or "-19" in l or "-20" in l or "cve-" in v or "cve-" in l:
            ...
            target_type = "NEEDS SPECIALIZED ENVIRONMENT"
        elif "sql" in v or "ecommerce" in v or "cart" in v or "payment" in v or "ssrf" in v or "deserialization" in v or "template" in v:
            family = "E-Commerce"
            app = "E-Commerce Platform"
            subdomain = "shop.hpvuln.in"
            functionality = "Search / Product / Cart functionality"
            target_type = "MAPPED"
        elif "cms" in v or "wordpress" in v or "upload" in v or "media" in v or "xxe" in v:
            family = "CMS/Media"
            app = "Content Management System"
            subdomain = "cms.hpvuln.in"
            functionality = "File Upload / Content creation"
            target_type = "MAPPED"
        elif "xss" in v or "csrf" in v or "clickjacking" in v or "cookie" in v or "cors" in v or "auth" in v or "bola" in v or "idor" in v or "lfi" in v or "rfi" in v or "cmd" in v or "prototype" in v:
            family = "SaaS"
            app = "SaaS Dashboard"
            subdomain = "dashboard.hpvuln.in"
            functionality = "User preferences / Profiles / Settings"
            target_type = "MAPPED"
        elif "business logic" in v or "workflow" in v or "privilege" in v or "parameter" in v or "race condition" in v or "cwe-" in v:
