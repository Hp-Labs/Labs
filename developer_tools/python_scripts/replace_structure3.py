...
end_right = content.find('{/*  LEFT: Lab Content  */}')  # This is the Normal Screen's left panel!

# The LiveEngagementScreen Right panel ends with the `LiveEngagementScreen` grid end.
# Which is basically before `</div>\n            </div>\n        </div>\n      </div>\n    );\n  }`
...
with open(path, "w", encoding="utf-8") as f:
    f.write(content)
print("Replaced structure beautifully.")
