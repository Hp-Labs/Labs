...
old_footer = """<footer className="py-8 border-t border-[var(--hp-border)] mt-auto bg-[var(--hp-bg)]/50">
...
if old_footer in content:
    ...
    with open(path, "w", encoding="utf-8") as f:
        f.write(content)
    print("Dashboard footer updated successfully!")
else:
    print("Old footer not found in dashboard!")
